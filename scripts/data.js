...
const PEOPLE = [
  ...
  { name: "Shiqi Li", category: "PhD Student", image: "Shiqi-Li.jpg" },
  ...
  { name: "Boyi Li", category: "PhD Student" },
  { name: "James Brock", category: "PhD Student" },
  { name: "Yifan Liang", category: "PhD Student", image: "Yifan-Liang.jpg" },
  { name: "Holly Liken", category: "PhD Student" },
  { name: "Mirah Zhang", category: "PhD Student" },
  { name: "Sultan Alotaibi", category: "PhD Student" },
  { name: "Chris Bean", category: "PhD Student" },
  { name: "Yujie Liang", category: "PhD Student" },
  { name: "Yijing Zhang", category: "PhD Student", image: "Yijing-Zhang.jpg" },
  { name: "Jade Zhou", category: "PhD Student", image: "Jade-Zhou.jpg" },
  { name: "Jim Hobson", category: "PhD Student", image: "Jim-Hobson.jpg" },
  { name: "Diego Maury Romero", category: "PhD Student", image: "Diego-Maury-Romero.jpg" },
];
